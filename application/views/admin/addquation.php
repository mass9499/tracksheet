                          ...
                          <?php if(getview('projects') == '1' || getedit('projects') == '1') { ?>
                              <td class="text-center">
                                  ...
                                  <?php if(getedit('projects') == '1') { ?>
                                    <a href="<?php echo base_url(); ?>quationandinvoice/addqutn_edit/<?php echo $project['project_id']; ?>"><small class="btn-primary" style="padding:4px 7px;border-radius:3px;"><i class="fa fa-edit"></i></small></a>
                                <?php } ?>
                              </td>
                          <?php } ?>
                        </tr>
