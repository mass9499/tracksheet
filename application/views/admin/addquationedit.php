<style>
    ...
    #footertabs > li:hover{
		...
		<div class="row">
			<div class="col-lg-12">
			    <form name="createprojectform" class="form-horizontal" novalidate="novalidate" method="POST" action="<?php echo base_url(); ?>quationandinvoice/addqutn_edit_save">
					...
					<div class="panel-body panel-body-nopadding">
						<div class="wizard-tabs" style="border-bottom:2px solid #e2e2e2;">
							...
							<div class="tab-content">
								<div id="w1-account" class="tab-pane "><br>
								    ...
								    <div class="col-md-12">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12" id="typeofbusinessdiv">
								...
								<div id="w1-profile" class="tab-pane active"><br>
								    <div class="col-md-12">
								        
							            <div class="col-md-12">
							    <?php if(!empty($project_tasks)) { ?>
                                        <div class="form-group">
                                          <label><h4>Project Tasks</h4></label>
                                                  ...
                                                  <tbody id="task_location">
                                                          ...
                                                          <?php $sl_no = $slno++; ?>
                                                            <tr id="<?php if($sl_no > 1) { echo 'row-'.$sl_no; } else { echo 'row'; } ?>">
                                                                ...
                                                                <td style="width:10%;">
                                                                    <input type="number" name="taskcost[]" id="<?php echo 'taskcost-'.$sl_no; ?>" class="form-control" placeholder="Enter Hours" value="" style="height:53px; box-shadow:2px 2px 2px silver;">
                                                                </td>
                                                            </tr>
                                                          <?php } ?>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            ...
                                                            <input  type="number" name="ttlhrs" value="" >
                                                            </div>
                                                            <div class="pull-right">
                                                            <lable >Total Cost</lable>
                                                            <input  type="number" name="ttlamnt" value="" >
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <br>
                                        ...
                                        <?php } ?>
                                                ...
                                                <center><h3> Design Details </h3></center>
					...
					<div class="panel-footer">
					    ...
					    <div class="wizard-tabs" style="border-bottom:2px solid #e2e2e2;">
							<ul class="wizard-steps" id="footertabs">
								...
								<li id="footertab4">
									<a href="#w1-assign" data-toggle="tab" class="text-center">
										<span class="badge hidden-xs">Step 4</span>
									</a>
								</li>
							</ul>
						</div>
