  ...
  <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.4.1/js/bootstrap.min.js"></script>
    ...
    <div class="container-fluid"><br>
        <form method="POST" action="<?php echo base_url(); ?>discussions">
              ...
              <div class="panel-body">
                  <div class="row">
                      <div class="col-md-9 noteinput">
                          <textarea rows="10" name="discussion_notes[]" class="form-control" >
                              <?php foreach($discuss_details as $discussions) {  ?>
                                <?php echo $discussions['discussion_note']; ?>
                      ...
                      <div class="col-md-3 assigninput">
                          ...
                          <?php $assigned_to = explode(":", $discussions['assignedto']); ?>
                            ...
                            <select class="form-control" name="assignedto0[]" multiple style="font-size:17px; border:3px solid #e2e2e2; border-radius:4px; min-height:190px; overflow-y: auto;">
                             <?php foreach($users as $user) { ?>
                               <option <?php if(in_array($user['login_id'], $assigned_to )) { ?> selected <?php } ?> value="<?php echo $user['login_id']; ?>"><?php echo $user['first_name'].' '.$user['last_name']; ?></option>
                             <?php } ?>
                            </select>
                      </div>
                  </div>
