                            ...
                            <main>
                                <div class="row contacts">
                                    <div class="col invoice-to">
                                        ...
                                        <h3 class="to"><input type="text" value="<?php echo $quation_tasksname['client_name']; ?>" style="border:none;"></h3>
                                        <div class="address"><input type="text" value="<?php echo $quation_tasksname['client_address']; ?>" style="border:none;width:100%;"></div>
                                        <!--<div class="email"><a href="">john@example.com</a></div>-->
                                    </div>
                                    <div class="col invoice-details">
                                        <h3 class="invoice-id">QUOTATION</h3>
                                        
                                        <div class="date">Project:<input type="text" value="<?php echo $quation_tasksname['project_name']; ?>" style="border:none;"></div>
                                        <div class="date">Invoice no:<input type="text" style="border:none;width: 10%;"></div>
                                        <div class="date">Date of Invoice: <input type="text" style="border:none;width: 10%;" value="<?php echo $quation_tasksdate; ?>"></div>
                                    
                                    </div>
                                </div>
                                <table id="print_width" border="0" cellspacing="0" cellpadding="0">
                                    <thead>
                                        <tr>
                                            <th>#</th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-left"><h3>
                                              <textarea rows="4" cols="40" style="border:none"></textarea>
                                            </td>
                                            <td class="unit"> <input type="text" style="border:none;width: 50%; "></td>
                                            <td class="qty"> <input type="text" style="border:none;width: 50%; "></td>
                                            <td class="total"> <input type="text" style="border:none;width: 50%;"></td>
                                        </tr>
                                    ...
                                    <tfoot>
                                        <tr>
                                            ...
                                            <td><input type="text" style="border:none;width: 50%;" placeholder="$100"></td>
                                        </tr>
                                        <tr>
                                            <td colspan="2"></td>
                                            <td colspan="2">TAX  <input type="text" style="border:none;width: 20%;" placeholder="$10">%</td>
                                            <td>₹ <input type="text" style="border:none;width: 50%;" placeholder="$10"></td>
                                        </tr>
                                        <tr>
                                            <td colspan="2"></td>
                                            <td colspan="2">GRAND TOTAL</td>
                                            <td>₹ <input type="text" style="border:none;width: 50%;"placeholder="$110"></td>
                                        </tr>
                                    </tfoot>
                                </table>
                                ...
                                <div class="notices">
                                    <div>NOTICE:</div>
                                    <div class="notice">
                                         <textarea rows="4" cols="80"  style="border:none;"></textarea>
                                    </div>
                                </div>
                            </main>
                            <footer>
